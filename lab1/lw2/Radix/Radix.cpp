...
//TODO Ќаписать что такое CHAR_OFFSETw высчитать
...
int CharToInt(char ch)
{
	...
	//TODO убрать присваивающее выражение
	int number = charByte >= 'A' ? charByte -= 'A' - CHAR_OFFSET : charByte -= '0';

	//TODO MAX_RADIX: MAX_DIGIT = MAX_RADIX - 1
...
int StringToInt(const std::string& str, int radix)
{
	...
	//TODO ƒобавить +
	if (str[0] == '-')//ƒобавить проверку строки на пустоту
	{
		isNegative = true;
	}

	//TODO объ€вить за пределами
...
{
	//TODO не использовать присваивающее выражение
